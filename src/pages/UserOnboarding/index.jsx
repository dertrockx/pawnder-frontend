...
const UserOnboarding = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // This is where pe put the axios thingy with multipart/form-data
...
const handleImageChange = (e) => {
  ...
  /**
   * This handler is solely for Chakra-UI's NumberInput.
   * It doesn't return an event object.
  ...
  // TASK: If possible, create custom hook for accessing user's location
            ...
            <div className={styles.formGroup} >
              ...
              <div className={styles.formFields} >
                ...
                <div className={styles.formItemSex}>
                  ...
                  <div classsName={styles.formItemSexOptions}>
                    <Radio 
                      name="sex"
                      value="m"
                      label="Male"
