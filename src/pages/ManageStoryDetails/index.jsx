        ...
        {matches ? (
            <form onSubmit = {handlePublish}>
                <div className = {styles.container}>
                    ...
                    <div className = {styles.uploadPicture}>
                        ...
                        <input name = "photo" id = "files" type="file" accept="image/*" className = {styles.visuallyHidden} onChange={onChangePicture} />
                        {hasImg ? 
                            (<Button
                                variant = "outline"
            ...
            <form onSubmit = {handlePublish}>
                <div className = {styles.container}>
                    ...
                    <img src={picture} alt = '' className = {styles.img} />
                    <div className = {styles.uploadPicture}>
                        <label for = "files" className = {styles.uploadLabel2}>Upload Photo</label>
                        <input name = "photo" id = "files" type="file" accept="image/*" className = {styles.visuallyHidden} onChange={onChangePicture} />
                        {hasImg ? 
                            (<Button
                                variant = "outline"
